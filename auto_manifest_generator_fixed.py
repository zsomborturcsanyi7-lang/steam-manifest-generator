...
Használat: python auto_manifest_generator_fixed.py <AppID>
"""
...
class AutoManifestGenerator:
    ...
    def find_steam_path(self):
        ...
        try:
            ...
            # Default Steam path
            default_path = Path(os.path.expanduser("~")) / "AppData" / "Local" / "Steam"
    ...
    def run(self):
        ...
        try:
            ...
            print("2. A jatek megjelenik a könyvtáradban")
            print("3. Telepítheted a Steam-rol")
    ...
    def get_game_info(self):
        ...
        try:
            ...
            if str(self.appid) in data and data[str(self.appid)]['success']:
                ...
                print(f"   Jatek neve: {self.game_name}")
            else:
                print(f"   Ismeretlen jatek, AppID használva")
                
        except Exception as e:
            print(f"   Nem sikerült lekérni a jateknevet: {e}")
    ...
    def fetch_depot_keys(self):
        ...
        for url in sources:
            try:
                ...
                print(f"   Figyelmeztetes: Nem sikerült betölteni {url}: {e}")
                continue
...
{{
    ...
    def copy_to_steam_folders(self, lua_path, manifests, acf_path):
        ...
        if not self.steam_path or not self.steam_path.exists():
            print("   Figyelmeztetes: Steam mappa nem található, másolás kihagyva")
            return
        ...
        try:
            ...
            print(f"   Figyelmeztetes: Másolási hiba: {e}")
...
def main():
    """Main function"""
    if len(sys.argv) != 2:
        print("Használat: python auto_manifest_generator_fixed.py <AppID>")
        print("Példa: python auto_manifest_generator_fixed.py 246620")
        sys.exit(1)
